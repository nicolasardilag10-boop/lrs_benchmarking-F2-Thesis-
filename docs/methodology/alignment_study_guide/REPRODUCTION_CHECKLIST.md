...
> Scope: historical 1k reproduction notes. Use [`../../FILE_INDEX.md`](../../FILE_INDEX.md) and the module READMEs for current 30× commands.
...
Expected: the interpreter from the `lrs-plots` environment, for example:

```text
.../envs/lrs-plots/bin/python
```
