...
OUTPUT_PNG = (
    ...
    / "30x"
    / "exploratory"
    / "mapped_unmapped_reads_percent_90_100.png"
)
...
OUTPUT_PDF = (
    ...
    / "30x"
    / "exploratory"
    / "mapped_unmapped_reads_percent_90_100.pdf"
)
...
data["mapped_reads_percent"] = pd.to_numeric(
    data["mapped_reads_percent"],
    errors="raise",
)


# Calculate the complementary unmapped-read percentage.
data["unmapped_reads_percent"] = (
    100.0
    - data["mapped_reads_percent"]
)
...
for panel_index, technology in enumerate(
    ...
    for sample in sample_order:
        ...
        # ----------------------------------------------------
        # UNMAPPED READS
        # Lighter version of the same sample color.
        # ----------------------------------------------------
...
# Neutral gray is used here because the actual mapped/unmapped
# distinction is dark versus light within each sample color.
...
# Extra top space prevents:
#
# 1. GIAB sample legend
# 2. mapped/unmapped legend
# 3. panel titles
#
# from overlapping.
...
print(
    "Mapped/unmapped reads figure created successfully."
)
